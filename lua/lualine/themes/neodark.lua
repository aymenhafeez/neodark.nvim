...
lualine.normal = {
  ...
  b = { bg = palette.bg4, fg = palette.blue },
  c = { bg = palette.bg4, fg = palette.fg },
}

lualine.insert = {
  a = { bg = palette.green, fg = palette.black },
  b = { bg = palette.bg4, fg = palette.green },
  c = { bg = palette.bg4, fg = palette.fg },
}

lualine.command = {
  a = { bg = palette.yellow, fg = palette.black },
  b = { bg = palette.bg4, fg = palette.yellow },
  c = { bg = palette.bg4, fg = palette.fg },
}

lualine.visual = {
  a = { bg = palette.purple, fg = palette.black },
  b = { bg = palette.bg4, fg = palette.purple },
  c = { bg = palette.bg4, fg = palette.fg },
}

lualine.replace = {
  a = { bg = palette.red, fg = palette.black },
  b = { bg = palette.bg4, fg = palette.red },
  c = { bg = palette.bg4, fg = palette.fg },
}

lualine.inactive = {
  a = { bg = palette.bg4, fg = palette.blue },
  b = { bg = palette.bg4, fg = palette.fg, gui = 'bold' },
  c = { bg = palette.bg4, fg = palette.fg },
}
