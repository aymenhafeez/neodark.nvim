...
function telescope.setup(palette)
  local telescope_ = {
    ...
    TelescopeSelectionCaret = { fg = palette.green, bg = util.darken(palette.blue, 0.5, palette.bg0) },
    TelescopeMatching = { fg = palette.bufline_yellow3 },
    TelescopeSelection = { fg = palette.none, bg = util.darken(palette.blue, 0.5, palette.bg0) },
