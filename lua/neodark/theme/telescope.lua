...
function telescope.setup(palette)
  local telescope_ = {
    ...
    TelescopeSelectionCaret = { fg = palette.green, bg = util.darken(palette.bg_blue, 0.5, palette.bg0) },
    TelescopeMatching = { fg = palette.orange },
    TelescopeSelection = { fg = palette.none, bg = util.darken(palette.bg_blue, 0.5, palette.bg0) },
