...
function bufferline.setup(palette)
  local bufferline_ = {
  --   BufferLineFill = { fg = palette.bufline_grey_fg, bg = palette.bg4 },
  --   -- BufferLineBackground = { fg = palette.bufline_grey_fg, bg = palette.bg1  },
  --   BufferLineBufferVisible = { fg = palette.bufline_light_grey, bg = palette.bg1 },
  ...
  --   BufferLineTabClose = { fg = palette.bufline_red, bg = palette.bg },
    ...
    -- BufferLineIndicatorVisible = { fg = palette.bufline_light_grey, bg = palette.bg1 },
  --   -- BufferLineSeparator = { fg = palette.bg1, bg = palette.bg1 },
  --   -- BufferLineSeparatorVisible = { fg = palette.bg1, bg = palette.bg1 },
  --   -- BufferLineSeparatorSelected = { fg = palette.bg1, bg = palette.bg1 },
