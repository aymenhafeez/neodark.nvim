...
function base.setup(palette)
  local base_ = {
    ...
    IncSearch = { fg = palette.none, bg = util.darken(palette.blue, 0.3, palette.bg0) },
    ...
    Search = { fg = palette.grey_3, bg = palette.blue },
